...
const player_snake = new Snake((canvas.width / blockSize / 2) * blockSize, (canvas.height / blockSize / 2) * blockSize, blockSize - 2, blockSize - 2);
// ========== Food ==========
class Food {
    constructor(x, y, w, h) {
        this.draw = () => {
...
const food = new Food(Math.floor(Math.random() * (canvas.width / blockSize)) * blockSize, Math.floor(Math.random() * (canvas.height / blockSize)) * blockSize, blockSize - 2, blockSize - 2);
// ========== Initialize ==========
animate();
